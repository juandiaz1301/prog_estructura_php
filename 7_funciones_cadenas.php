...
<body>
    ...
    <h2>función ereg()</h2>
    <?php
    // Este ejemplo solo funciona en PHP antiguo
    $texto = "Hola Mundo";
    if (ereg("Hola", $texto)) {
    ...
    <?php
    $texto = "Hola Mundo";
    if (preg_match("/hola/i", $texto)) { // la 'i' hace la búsqueda insensible a mayúsculas
    echo "Coincidencia encontrada (insensible a mayúsculas).";
    }
    ?>
</body>
</html>